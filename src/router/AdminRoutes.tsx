...
const AdminCandidatesPage = lazy(
  () => import("@/features/admin/candidates/pages/AdminCandidatesPage"),
)
...
const AdminCompanyDetailsPage = lazy(
  () => import("@/features/admin/companies/pages/AdminCompanyDetailsPage"),
)
...
const AdminApplicationsPage = lazy(
  () => import("@/features/admin/applications/pages/AdminApplicationsPage"),
)
const AdminApplicationDetailsPage = lazy(
  () => import("@/features/admin/applications/pages/AdminApplicationDetailsPage"),
)
...
const AdminReportsOverviewPage = lazy(
  () => import("@/features/admin/reports/pages/AdminReportsOverviewPage"),
)
const AdminReportsApplicationsPage = lazy(
  () => import("@/features/admin/reports/pages/AdminReportsApplicationsPage"),
)
const AdminReportsJobsPage = lazy(
  () => import("@/features/admin/reports/pages/AdminReportsJobsPage"),
)
const AdminReportsCvParsingPage = lazy(
  () => import("@/features/admin/reports/pages/AdminReportsCvParsingPage"),
)
...
export const adminRoutes: RouteObject = {
  ...
  children: [
    ...
    {
      path: ROUTES.admin.companyDetails(":id"),
      element: withRouteSuspense(<AdminCompanyDetailsPage />),
    },
    ...
    {
      path: ROUTES.admin.applicationDetails(":id"),
      element: withRouteSuspense(<AdminApplicationDetailsPage />),
    },
