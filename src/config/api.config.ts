...
export const API_ENDPOINTS = Object.freeze({
  ...
  admin: {
    ...
    userApplications: (id: string | number) => `/admin/users/${id}/applications`,
    userInterviews: (id: string | number) => `/admin/users/${id}/interviews`,
    userJobs: (id: string | number) => `/admin/users/${id}/jobs`,
    userTestAssignments: (id: string | number) => `/admin/users/${id}/test-assignments`,
    userActivity: (id: string | number) => `/admin/users/${id}/activity`,
    userAuditLogs: (id: string | number) => `/admin/users/${id}/audit-logs`,
