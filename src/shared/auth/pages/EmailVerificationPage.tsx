    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold tracking-tight">{t("emailVerification.title")}</h1>
          <p className="mt-2 text-sm text-muted-foreground">{t("emailVerification.subtitle")}</p>
        </div>
